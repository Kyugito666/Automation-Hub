...
namespace Orchestrator.TUI 
{
    internal static class TuiMenus
    {
        ...
        // === SEMUA FUNGSI UNTUK MENU 4, 5, 6 (ShowRecordMenuAsync, ShowAttachMenuAsync, ShowRemoteShellAsync, dll) DIHAPUS DARI SINI ===
    }
}
